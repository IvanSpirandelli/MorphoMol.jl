module Energies
    ...
    export get_total_persistence_summed, get_total_persistence, get_divided_persistence, get_divided_persistence_summed
    export get_interface_diagram, get_interface_diagram_and_filtration
